...
namespace MainLedger.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260206184153_AddExternalLoginsForSSO")]
    partial class AddExternalLoginsForSSO
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MainLedger.Domain.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MainLedger.Domain.Entities.EmailNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MainLedger.Domain.Entities.ExternalLogin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MainLedger.Domain.Entities.ExtractionCandidate", b =>
                {
                    ...
                    b.Property<string>("EmailMessageIdExternal")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("MerchantOriginal")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MainLedger.Domain.Entities.SubscriptionPlan", b =>
                {
                    ...
                    b.Property<int>("ClassificationLimit")
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("ExtractionLimit")
                        .HasColumnType("integer")
                        .HasColumnName("extraction_limit");
            ...
            modelBuilder.Entity("MainLedger.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("NotifyOnClassification")
                        .HasColumnType("boolean");

                    b.Property<bool>("NotifyOnEmailSync")
                        .HasColumnType("boolean");

                    b.Property<bool>("NotifyOnExtraction")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("MainLedger.Domain.Entities.UserSubscription", b =>
                {
                    ...
                    b.Property<int>("EmailsClassifiedThisMonth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("emails_classified_this_month");

                    b.Property<int>("EmailsExtractedThisMonth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
            ...
            modelBuilder.Entity("MainLedger.Domain.Entities.WebhookDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MainLedger.Domain.Entities.WebhookEndpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MainLedger.Domain.Entities.ExtractionCandidate", b =>
                {
                    b.HasOne("MainLedger.Domain.Entities.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("MainLedger.Domain.Entities.WebhookDelivery", b =>
                {
                    b.HasOne("MainLedger.Domain.Entities.WebhookEndpoint", "WebhookEndpoint")
                        .WithMany("Deliveries")
