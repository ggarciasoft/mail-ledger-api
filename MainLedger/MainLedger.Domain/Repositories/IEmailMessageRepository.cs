...
public interface IEmailMessageRepository
{
    ...
    Task<EmailMessage?> GetByMessageIdAsync(
        string messageId,
    ...
    Task<List<EmailMessage>> GetUnprocessedAsync(
        Guid userId,
        int limit,
        CancellationToken cancellationToken = default
    );
    Task<List<EmailMessage>> GetByProcessingStatusAsync(
        Guid userId,
        Enums.EmailProcessingStatus status,
        int limit,
        CancellationToken cancellationToken = default
    );
    Task<List<EmailMessage>> GetClassifiedFinancialEmailsAsync(
        Guid userId,
        int limit,
        CancellationToken cancellationToken = default
    );
    ...
    Task<Models.EmailStatistics> GetStatisticsAsync(
        Guid userId,
        CancellationToken cancellationToken = default
    );
    Task<int> CountByUserIdAsync(Guid userId, CancellationToken cancellationToken = default);
    Task<List<Models.SyncHistoryItem>> GetSyncHistoryAsync(
        Guid userId,
        int limit,
        CancellationToken cancellationToken = default
    );
    Task<List<EmailMessage>> GetPendingClassificationAsync(
        Guid userId,
        int limit,
        CancellationToken cancellationToken = default
    );
    Task<List<EmailMessage>> GetPendingExtractionAsync(
        Guid userId,
        int limit,
        CancellationToken cancellationToken = default
    );
